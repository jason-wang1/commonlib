...
class RedisProtoData_SingleCache_Long : public testing::Test
{
public:
    using Value = long;
...
// 测试条件1: value值不为空
// 测试条件2: 获取缓存值内容一致
TEST_F(RedisProtoData_SingleCache_Long, SetCacheData)
{
    Value value = 12345;
...
// 测试条件1: value值为空
// 测试条件2: 获取缓存值内容一致
TEST_F(RedisProtoData_SingleCache_Long, MoveSetCacheData)
{
    Value value = 12345;
