...
class RedisProtoData_VectorCache : public testing::Test
{
public:
...
// 测试条件1: value值不为空
// 测试条件2: 获取缓存值内容一致
TEST_F(RedisProtoData_VectorCache, SetCacheData)
{
    int idx = 0;
...
// 测试条件1: value值为空
// 测试条件2: 获取缓存值内容一致
TEST_F(RedisProtoData_VectorCache, MoveSetCacheData)
{
    int idx = 0;
    Value value = "proto_12345";
...
// 测试条件1: value值为空
// 测试条件2: 获取缓存值内容一致
TEST_F(RedisProtoData_VectorCache, AppendCacheData)
{
    int idx1 = 1;
    Value value0 = "proto_12345";
    Value value1 = "proto_123456";
